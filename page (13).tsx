          ...
          <form action={createCourse} className="space-y-5">
            <label className="block">
              ...
              <input
                ...
                className="mt-2 w-full rounded-xl border border-slate-300 bg-white px-3 py-3 text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
              />
            </label>
            ...
            <label className="block">
              ...
              <textarea
                ...
                className="mt-2 w-full resize-none rounded-xl border border-slate-300 bg-white px-3 py-3 text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
              />
            </label>
            ...
            <label className="block">
              ...
              <div className="relative mt-2">
                <input
                  ...
                  step="1"
                  placeholder="Ex.: 40"
                  className="w-full rounded-xl border border-slate-300 bg-white px-3 py-3 pr-14 text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                />
                    ...
                    >
                      ...
                      <label className="block">
                        ...
                        <textarea
                          ...
                          className="mt-2 w-full resize-none rounded-xl border border-slate-300 bg-white px-3 py-3 text-slate-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                        />
                      </label>
